  ...
  return (
    <div className='min-h-screen bg-white font-sans'>
      ...
      <nav className='container mx-auto px-6 py-4 flex justify-between items-center'>
        ...
        {/* Баруун талын үйлдэл хийх товчнууд (Зассан хэсэг) */}
        <div className='flex items-center gap-4'>
          ...
          <Link
            to='/login'
            className='bg-blue-100 text-blue-600 px-5 py-2 rounded-full font-semibold hover:bg-blue-200 transition'
          >
            Нэвтрэх
          </Link>
        </div>
      ...
      <section className='container mx-auto px-6 py-20 text-center'>
        ...
        <p className='text-gray-500 max-w-2xl mx-auto mb-10 text-lg'>
          Бид таныг ур чадварт тань тохирсон цагийн ажил болон богино хугацааны
          төслүүдтэй шуурхай холбож, найдвартай орлоготой болоход тань тусална.
        </p>
      </section>
      ...
      <section className='container mx-auto px-6 py-20'>
        <div className='flex justify-between items-center mb-10'>
          ...
          <a
            href='#'
            className='text-gray-900 font-semibold hover:text-blue-600 flex items-center gap-1'
          >
        ...
        {loading ? (
          <div className='text-center text-gray-500 py-10'>
            Түр хүлээнэ үү, мэдээллийг татаж байна...
          </div>
        ) : jobs.length === 0 ? (
          <div className='text-center text-gray-500 py-10'>
            Одоогоор шинэ ажлын зар алга байна.
          </div>
        ) : (
